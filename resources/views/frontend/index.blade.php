...
@section('content')
    ...
    <div class="container-fluid vesitable ">
        <div class="container ">
            ...
            <div class="shadow d-flex align-items-center justify-content-between p-3 mt-3 mb-3">
                <div class="text-primary col-lg-2">
                    <p class="fs-5 text-nowrap">On Sale Now</p>
                </div>

                <div class="col-lg-2">
                    <h1 id="timer" class=" fs-4 text-primary"> 00:00:00</h1>
                </div>
                <script>
                    let timerInterval;
                    let seconds = 0;
