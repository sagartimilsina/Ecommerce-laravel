...
@section('content')
    ...
    <div class="container-fluid py-2">
        ...
        <div class="container ">
            ...
            <form id="checkoutForm" action="{{ route('checkout') }}" method="GET"> <!-- Added form element -->
                @csrf
                                ...
                                <tr data-cart-id="{{ $cartItem->id }}">
                                    ...
                                    <td>
                                        <div class="form-check">
                                            ...
                                            <!-- Add a hidden input to hold the selected item IDs -->
                                    ...
                                    {{-- <td>
                                        <form id="deleteForm{{ $cartItem->id }}"
                                            action="{{ route('delete_cart', $cartItem->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            //     if (button) {
            //         event.stopPropagation(); // Stop propagation to prevent multiple clicks
            ...
            //         // Disable the minus button if quantity is already 1
            //         const minusButton = cartRow.querySelector('.btn-minus');
            //         minusButton.disabled = quantity === 1;

            //         // Disable the plus button if quantity is equal to or greater than stock
