                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="row">
                        <div class="col-lg-12 mb-4 order-0">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active text-primary"><a
                                                    href="javascript:void(0);">Pending Users List</a></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card mt-4">
                                <h3 class="card-title fs-4 m-3 mb-2 text-primary">Pending Users Orders</h3>
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach ($pending_orders as $order)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ route('show_all_users_pending_orders', $order->user->id) }}">
