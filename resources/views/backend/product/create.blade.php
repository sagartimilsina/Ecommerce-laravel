                                        ...
                                        <div class="float-right d-none d-md-block">
                                            <div class="">
                                                <a href="{{ route('products.index') }}" data-toggle="modal"
                                                    ...
                                                    <i class="fa-solid fa-arrow-left px-1"></i>Back</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="card mb-4">
                                                            <div class="card-body">
                                                                <form action="{{ route('products.store') }}" method="POST"
                                                                    ...
                                                                    <div class="row mb-2">
                                                                        <div class="col-lg-6 col-sm-6 col-md-6 col-12 ">
                                                                            <label for=" form-label " class="text-primary">
                                                                                Image:
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-6 col-sm-6 col-md-6 col-12">
                                                                            <label class="form-label text-primary"
                                                                                for="image-category">Product Discount:<span
                                                                                    class="text-danger"></span></label>
                                                                    ...
                                                                    <div class=" mb-3">
                                                                        <label for="parent page "
                                                                            ...
                                                                            Description:</label>
                                                                        <textarea id="editor" class="form-control" name="product_description" placeholder="Enter description">{{ old('product_description') }}</textarea>
                                                                        <div class="text-danger m-2">
